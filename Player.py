...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            ...
            # we're going to check that thisis a correct value by trying to cast
            # it to and integer, and if its not, then we say its invalid
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if state.current_winner == other_player:
            # we need to return the position AND the score to keep track of the score
            # for minimax to work
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move # otherwise this is will get messed up from recursion
